<div class="accordion accordion-flush" id="accordionBillpaymentModal">
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="flush-heading{{ $key }}">
                <button class="accordion-button p-2 collapsed" type="button" data-bs-toggle="collapse"
                    ...
                    Tagihan Pembelian {{ $itemTransaction['transaction_receipt_number'] }} Pada {{ $formattedDate }}
                </button>
            </h2>
            <div id="flush-collapse{{ $key }}" class="accordion-collapse collapse"
                aria-labelledby="flush-heading{{ $key }}" data-bs-parent="#accordionBillpaymentModal">
