        ...
        <div class="row px-2 px-md-0">
            <div class="card p-0" style="border-radius: 10px;">
                <div class="card-body p-md-4">
                    ...
                    @if (isset($data['detail']['step']))
                        <h5 class="text-blue fw-bold mb-3">Step Pembayaran</h5>
                        {!! $data['detail']['step'] !!}
                    @endif

                    @if (isset($data['detail']['url_file_rekap'])) 
                        <a class="mt-2 text-blue text-decoration-none" href="{{ $data['detail']['url_file_rekap'] }}">Download Rekap</a>
                    @endif
                    ...
                    @foreach ($data['detail']['payments'] as $key => $payment)
                        ...
                        <div class="px-2">
                            ...
                            <p class="mb-0">Tagihan pembelian - {{ $payment['transaction_receipt_number'] }}</p>
                        </div>
                    ...
                    <div class="card-footer border-0 py-2 bg-blue"
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless align-middle">
                                <tbody>
                                    <tr>
                                        <td class="fs-4 text-light fw-bold" style="background: transparent;">
                                            Total</td>
                                        <td class="fs-4 text-light fw-bold text-end" style="background: transparent;">
